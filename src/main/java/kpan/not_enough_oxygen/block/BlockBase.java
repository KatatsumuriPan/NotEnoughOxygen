...
import kpan.not_enough_oxygen.block.item.ItemBlockBase;
import kpan.not_enough_oxygen.block.item.ItemBlockVariants;
import kpan.not_enough_oxygen.item.ItemInit;
import kpan.not_enough_oxygen.util.PropertyUtil;
