...
public class ModGuiConfig extends GuiScreen {
    ...
    public ModGuiConfig(GuiScreen owningScreen) {
        this(owningScreen, ModMain.defaultConfig.getRootCategory().getOrderedElements(), null, false, false, ModTagsGenerated.MODNAME, "");
    }
            ...
            try {
                if ((configID != null || parentScreen == null || !(parentScreen instanceof ModGuiConfig))
                    ...
                    if (!event.getResult().equals(Result.DENY)) {
                        ModMain.defaultConfig.storeToFieldAndSave();
